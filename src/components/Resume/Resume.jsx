...
const resumeData = {
  ...
  contactInfo: [
    {
      type: "LinkedIn",
      url: "www.linkedin.com/abcd",
      isLink: true,
    },
    {
      type: "GitHub",
      url: "www.github.com/xyz-kunal",
      isLink: true,
    },
    {
      type: "Email",
      url: "kunalkhandelwal6999@gmail.com",
      isLink: false,
    },
    {
      type: "Mobile",
              ...
              <section className="break-inside-avoid">
                ...
                <section className="mb-2 break-inside-avoid">
                  <p className="mt-2 leading-normal text-gray-700 text-md">
                    Experienced full-stack web developer with a strong track
                    record of independently addressing complex business
                    requirements and overcoming challenges to deliver polished
              ...
              <section className="break-inside-avoid">
                ...
                <section className="pb-4 mt-4 mb-4 border-b-2 break-inside-avoid">
                  ...
                  <ul className="mt-2 list-disc list-inside text-gray-800 text-md">
                    ...
                    <li>
                      <span className="font-semibold text-md">Skills:</span>
                      Programming, Algorithms, Data Structures, Software
                      Development
                    </li>
                  </ul>
                </section>
                ...
                <section className="mb-2 border-b-2 border-gray-300 break-inside-avoid">
                  ...
                  <ul className="pl-3 mt-2 font-normal text-gray-700 text-md leading-snugish">
                    <li>
                      ...
                      Created high-quality, customized web applications from
                      scratch, employing a diverse set of programming languages,
                      including HTML, CSS, JavaScript, PHP, and Python, to
                      fulfill unique client requirements.
                    </li>
                    <li>
                      <span className="text-gray-500 transform -translate-y-px select-none">
                        &rsaquo;
                      </span>
                      Leveraged a range of bleeding edge front-end frameworks
                      like React.js, Nullstack and Vue.js, as well as back-end
                      frameworks such as Node.js and Express, to deliver robust
                    ...
                    <li>
                      ...
                      technologies like MySQL, PostgreSQL, MongoDB, and
                      Firebase, optimizing data storage and management.
                    </li>
                  </ul>
                </section>
                <section className="mb-2 border-b-2 border-gray-300 break-inside-avoid">
                  ...
                  <ul className="pl-3 mt-2 font-normal text-gray-700 text-md leading-snugish">
                    <li>
                      ...
                      Provided expert computer repair services to individuals
                      and businesses, diagnosing and resolving hardware and
                ...
                <section className="mb-2 border-b-2 border-gray-300 break-inside-avoid">
                  ...
                  <ul className="pl-3 mt-2 font-normal text-gray-700 text-md leading-snugish">
                    <li>
                      ...
                      Trained and supervised staff in product knowledge,
                      customer engagement, and sales techniques, ensuring a
                      top-notch shopping experience for customers.
                    </li>
                    <li>
                      <span className="text-gray-500 transform -translate-y-px select-none">
                        &rsaquo;
                      </span>
                      Maintained a pristine and organized store environment,
                      fostering maximum customer satisfaction.
                    </li>
                    <li>
                      <span className="text-gray-500 transform -translate-y-px select-none">
                        &rsaquo;
                      </span>
                      Demonstrated deep expertise in the pet food industry,
                      including trends, products, and competitors, providing
                      customers with informed recommendations and advice.
                    </li>
                  </ul>
                </section>
                <section className="mb-2 border-b-0 border-gray-300 break-inside-avoid">
                  ...
                  <ul className="pl-3 mt-2 font-normal text-gray-700 text-md leading-snugish">
                    <li>
                      ...
                      business executive, managing schedules, travel
                      arrangements, and coordinating meetings and events.
                    </li>
                    <li>
                      <span className="text-gray-500 transform -translate-y-px select-none">
                        &rsaquo;
                      ...
                      including answering phone calls and emails, ensuring
                      timely and professional responses to inquiries and
                      requests.
                    </li>
                    <li>
                      <span className="text-gray-500 transform -translate-y-px select-none">
                      ...
                      Maintained relationships with vendors, clients, and
                      external stakeholders, ensuring professionalism and
                      alignment with the business's values.
                    </li>
                  </ul>
                </section>
              </section>
